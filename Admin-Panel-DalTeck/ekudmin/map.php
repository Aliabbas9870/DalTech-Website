...
<div class="container-fluid">
    ...
    <!-- /.dash-navbar-left -->
    <!--  map area start -->
    <div class="map-page mar_lft_282 all-bg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-title-area">
                        <h3>Maps</h3>
                        <h4>Maps / Google maps</h4>
                    </div>
                </div>
            </div>
            <div class="wraper-bg-allpage">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="map-area">
                            <h3 class="map-title">Default Map</h3>
                            <div class="map"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="map-area">
                            <h3 class="map-title">Satellite Map</h3>
                            <div class="map_se"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="map-area">
                            <h3 class="map-title">Regular Map</h3>
                            <div class="map_se2"></div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="map-area">
                            <h3 class="map-title">Custom Map Style</h3>
                            <div class="map_se3"></div>
                        </div>
                    </div>
                </div>
            </div>
